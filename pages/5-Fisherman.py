...
npc = {
"name" : "Fisherman",
"input" : "A fisherman with no particular propensity to be helpful or harmful. He has very little to say, except the important message that he never saw any boy and that he thinks that the mausoleum would be a better place to check. After the initial conversation, he repeats that the mausoleum is the place to look for the boy but otherwise is unresponsive. ",
"near" : "Bridge",
"description" : "You turn the corner of the road and come across a man patiently bent over a fishing rod on the bridge. He appears to be nodding off, but he turns as you approach and gives you a half-salute around his wide-brimmed hat. Beyond him, the gardens meander in a vast spread of undistinguished green.",
"icon" : "🎣",
"lat" : 52.52643,
"lng" : 13.29486,
"img" : "Fisherman"
