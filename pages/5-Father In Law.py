...
npc = {
"name" : "Father In Law",
"input" : "An old, grouchy man that wants to help you find his grandson the prince because he is the future of the family. He is pretentious by nature but holds no ill will towards his grandson or you. He does work into the conversation how much he dislikes his son, whose only achievement in his eyes was siring the young military-oriented prince. When you first speak to him, he speaks shortly with you, until he realizes that you earnestly want to find his grandson. The man is the Great Elector, which he makes sure to work into the conversation, and he wishes that his first son survived instead of just Frederick. He urges you to find his grandson, because the alternative of having Frederick on the throne is unthinkable. He also hates his son’s wife Sophie Charlotte, but when you ask about where the prince can be found he points towards the flowers. He tells you that his son’s wife is just as useless as his son and so is meandering in the flower beds rather than searching for her son, who is the heir to the throne. He urges you forward, because otherwise his legacy will be destroyed forever by his prissy son. ",
"near" : "Fountain",
"description" : "The burbling fountain provides a soothing contrast to the urgency of your mission. The clearing is framed by the dark green of the trees in the surrounding area, where the prince must be hiding somewhere. In front of the fountain, an old man clad in rich fabric sits in an over-embellished chair. Several people in plain clothing surround him demurely, holding shade over him and carrying water and other refreshments. Age has etched deep wrinkles that suggest more frowns then smiles over his lifetime. He’s certainly not smiling now as he watches you approach, but he seems unsurprised by your sudden intrusion into the gardens. ",
"icon" : "👴",
 "lat" : 52.52245,
"lng" : 13.29518,
"img" : "Father"
